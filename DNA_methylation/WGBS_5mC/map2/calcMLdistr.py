...
with open(expression) as fh:
    for rec in fh:
        ...
        if tpm<0.5:
            exps[gname] = "None"
        elif tpm >=0.5 and tpm < 10:
            exps[gname] = "Low"
        elif tpm >=10 and tpm < 1000:
            exps[gname] = "Medium"
        elif tpm >= 1000:
            exps[gname] = "High"
        else:
...
def calc(bed):
    ...
    return (exps[gene], MLmc_ss, MLmc_nss)
