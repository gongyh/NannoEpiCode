...
# read in files
mat_hc1 <- read.table("../hic_results/matrix/H0rep/raw/10000/H0rep_10000.matrix")
bed_hc1 <- read.table("../hic_results/matrix/H0rep/raw/10000/H0rep_10000_abs.bed")
# convert to BEDPE
dat_hc1 <- hicpro2bedpe(mat_hc1, bed_hc1)
hc1 <- dat_hc1$cis # extract intrachromosomal matrices

# read in files
mat_hc2 <- read.table("../hic_results/matrix/H24rep/raw/10000/H24rep_10000.matrix")
bed_hc2 <- read.table("../hic_results/matrix/H24rep/raw/10000/H24rep_10000_abs.bed")
# convert to BEDPE
...
write.table(hict[hict$p.adj<0.01,], file="Rep2_10k.txt", quote=F, sep="\t")
