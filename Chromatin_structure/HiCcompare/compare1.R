...
# read in files
mat_hc1 <- read.table("../hic_results/matrix/NannoH0/raw/10000/NannoH0_10000.matrix")
bed_hc1 <- read.table("../hic_results/matrix/NannoH0/raw/10000/NannoH0_10000_abs.bed")
# convert to BEDPE
dat_hc1 <- hicpro2bedpe(mat_hc1, bed_hc1)
hc1 <- dat_hc1$cis # extract intrachromosomal matrices

# read in files
mat_hc2 <- read.table("../hic_results/matrix/NannoH24/raw/10000/NannoH24_10000.matrix")
bed_hc2 <- read.table("../hic_results/matrix/NannoH24/raw/10000/NannoH24_10000_abs.bed")
# convert to BEDPE
...
write.table(hict[hict$p.adj<0.01,], file="Rep1_10k.txt", quote=F, sep="\t")
