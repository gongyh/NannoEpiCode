...
pdf("NannoEpi_HiC_AB_chr1.pdf", useDingbats=FALSE, width=5, height=2, family="Arial", onefile=F)

HC_data <- HC_R1_df[HC_R1_df$V1=="chr1",]
LC_data <- LC_R1_df[LC_R1_df$V1=="chr1",]
