...
HC_R1_df <- read.table('../NannoH0/iced/1000/NannoH0_1000_iced.matrix', sep="\t", header=F)
HC_R2_df <- read.table('../H0rep/iced/1000/H0rep_1000_iced.matrix', sep="\t", header=F)
LC_R1_df <- read.table('../NannoH24/iced/1000/NannoH24_1000_iced.matrix', sep="\t", header=F)
LC_R2_df <- read.table('../H24rep/iced/1000/H24rep_1000_iced.matrix', sep="\t", header=F)
...
pdf("NannoEpi_HiC_1k_replicate_pearson.pdf", useDingbats=FALSE, width=8.5, height=4, family="Arial", onefile=F)
