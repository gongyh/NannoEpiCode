...
des <- read.table("M4_DEs.txt",header=F,stringsAsFactors=F)
...
gl <- read.table("M4_logfc.tsv",header=F,sep="\t",stringsAsFactors=F)
geneList <- gl$V2
...
pdf("M4.pdf", useDingbats = FALSE, width = 12, height = 6, family="Arial")
