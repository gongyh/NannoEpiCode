...
H0_H3k4m2_df$Type <- "H3k4me2"

data <- rbind(H0_H3k9ac_df,H0_H3k27ac_df,H0_H3kcr_df,H0_H3k4m2_df)
data$Type <- factor(data$Type, ordered=TRUE, levels = c("H3k9ac", "H3k27ac", "Kcr", "H3k4me2"))
str(data)

pdf("NannoEpi_Histone_H0_TPM.pdf", useDingbats = FALSE, width = 11, height = 3.5, family="Arial")
...
ggboxplot(data,x="Group",y="Control",fill="Group",palette="npg", width=0.5, add="none", bxp.errorbar=T, 
                size=0.2, outlier.shape=NA, facet.by="Type", nrow=1) + theme_bw() +
