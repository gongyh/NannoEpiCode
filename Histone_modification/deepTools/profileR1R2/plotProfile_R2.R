...
H0_profiles <- rbind(bins=bins1, H0_H3k9ac=H0_H3k9ac_R2, H0_H3k27ac=H0_H3k27ac_R2, H0_Kcr=H0_H3kcr_R2, H0_H3k4me2=H0_H3k4m2_R2)
...
H24_profiles <- rbind(bins=bins2, H24_H3k9ac=H24_H3k9ac_R2, H24_H3k27ac=H24_H3k27ac_R2, H24_Kcr=H24_H3kcr_R2, H24_H3k4me2=H24_H3k4m2_R2)
...
R2_data <- melt(df, id.vars="bins", measure.vars=c("H0_H3k9ac","H0_H3k27ac","H0_Kcr","H0_H3k4me2","H24_H3k9ac","H24_H3k27ac","H24_Kcr","H24_H3k4me2"))

out <- str_split_fixed(R2_data$variable, "_", 2)
R2_data$condition <- out[,1]
R2_data$histone <- out[,2]

str(R2_data)

pdf("NannoEpi_histone_profile_R2.pdf", useDingbats = FALSE, width = 10, height = 10, family="Arial")

#par(family="Arial", ps=16)
#par(mar=c(5.1, 4.1, 4.1, 3.1), mgp=c(3, 1, 0), las=0)

R2_data$histone <- factor(R2_data$histone, levels=c("H3k9ac","H3k27ac","Kcr","H3k4me2"), ordered=T)

ggline(R2_data, x="bins", y="value", group="condition", color="condition", palette="npg", facet.by="histone", nrow=2,
