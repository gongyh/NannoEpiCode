...
H0_H3k27ac_profile <- read.delim("H0_H3k27ac.plotProfile.tab")
bins <- H0_H3k27ac_profile[1,3:dim(H0_H3k27ac_profile)[2]]
H0_H3k27ac <- H0_H3k27ac_profile[2,3:dim(H0_H3k27ac_profile)[2]]

H0_H3k9ac_profile <- read.delim("H0_H3k9ac.plotProfile.tab")
H0_H3k9ac <- H0_H3k9ac_profile[2,3:dim(H0_H3k9ac_profile)[2]]

H0_H3k4m2_profile <- read.delim("H0_H3k4m2.plotProfile.tab")
H0_H3k4m2 <- H0_H3k4m2_profile[2,3:dim(H0_H3k4m2_profile)[2]]

H0_H3kcr_profile <- read.delim("H0_H3kcr.plotProfile.tab")
H0_H3kcr <- H0_H3kcr_profile[2,3:dim(H0_H3kcr_profile)[2]]
