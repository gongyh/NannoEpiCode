...
H24_H3k27ac_profile <- read.delim("H24_H3k27ac.plotProfile.tab")
bins <- H24_H3k27ac_profile[1,3:dim(H24_H3k27ac_profile)[2]]
H24_H3k27ac <- H24_H3k27ac_profile[2,3:dim(H24_H3k27ac_profile)[2]]

H24_H3k9ac_profile <- read.delim("H24_H3k9ac.plotProfile.tab")
H24_H3k9ac <- H24_H3k9ac_profile[2,3:dim(H24_H3k9ac_profile)[2]]

H24_H3k4m2_profile <- read.delim("H24_H3k4m2.plotProfile.tab")
H24_H3k4m2 <- H24_H3k4m2_profile[2,3:dim(H24_H3k4m2_profile)[2]]

H24_H3kcr_profile <- read.delim("H24_H3kcr.plotProfile.tab")
H24_H3kcr <- H24_H3kcr_profile[2,3:dim(H24_H3kcr_profile)[2]]
