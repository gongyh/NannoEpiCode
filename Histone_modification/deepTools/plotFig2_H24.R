...
pdf("NannoEpi_Fig2_H24.pdf", useDingbats = FALSE, width = 7, height = 6, family="Arial")
...
p1 <- ggboxplot(H24_H3k9ac_df,x="Group",y="Control",fill="Group",palette="npg", width=0.5,
  ...
  xlab("Clusters of H3k9ac (H24)") + ylab("TPM of genes") + 
...
p2 <- ggboxplot(H24_H3k27ac_df,x="Group",y="Control",fill="Group",palette="npg", width=0.5,
          add="none", bxp.errorbar=T, size=0.2, outlier.shape = NA, ylim=c(0,300)) + theme_bw() +
  theme(text=element_text(size=11, family="Arial"), legend.position="none",
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        axis.text.x = element_text(color="black"),
        axis.text.y = element_text(color="black")) +
  xlab("Clusters of H3k27ac (H24)") + ylab("TPM of genes") + 
  stat_compare_means(method="wilcox.test", comparisons=comparisons, family="Arial", 
        tip.length=0.001, size=3, label.y=c(290,270,250,230,210,190,170))

p3 <- ggboxplot(H24_H3kcr_df,x="Group",y="Control",fill="Group",palette="npg", width=0.5,
          add="none", bxp.errorbar=T, size=0.2, outlier.shape = NA, ylim=c(0,300)) + theme_bw() +
  theme(text=element_text(size=11, family="Arial"), legend.position="none",
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        axis.text.x = element_text(color="black"),
        axis.text.y = element_text(color="black")) +
  xlab("Clusters of H3kcr (H24)") + ylab("TPM of genes") + 
  stat_compare_means(method="wilcox.test", comparisons=comparisons, family="Arial", 
        tip.length=0.001, size=3, label.y=c(290,270,250,230,210,190,170))

p4 <- ggboxplot(H24_H3k4m2_df,x="Group",y="Control",fill="Group",palette="npg", width=0.5,
          add="none", bxp.errorbar=T, size=0.2, outlier.shape = NA, ylim=c(0,300)) + theme_bw() +
  theme(text=element_text(size=11, family="Arial"), legend.position="none",
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        axis.text.x = element_text(color="black"),
        axis.text.y = element_text(color="black")) +
  xlab("Clusters of H3k4m2 (H24)") + ylab("TPM of genes") + 
  stat_compare_means(method="wilcox.test", comparisons=comparisons, family="Arial", 
        tip.length=0.001, size=3, label.y=c(290,270,250,230,210,190,170))
