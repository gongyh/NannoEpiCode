...
pdf("NannoEpi_Scatter_2x2.pdf", useDingbats=FALSE, width=6, height=6, family="Arial")

data$Mutant <- factor(data$Mutant, ordered=TRUE, levels = c("H3K9ac", "H3K27ac", "Kcr", "H3K4me2"))

ggscatter(data, x="plogFC", y="logFC", color="black", shape=21, size=0.3, facet.by="Mutant",ncol=2,
