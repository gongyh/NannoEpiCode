...
pdf("NannoEpi_MNase_replicate_pearson_v.pdf", useDingbats=FALSE, width=4.5, height=8, family="Arial", onefile=F)
...
ggarrange(hc, lc, nrow=2, legend="right", common.legend=T)
